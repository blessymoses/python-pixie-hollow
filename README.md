# Python
- [`logzero` library for Python Logging](https://github.com/blessymoses/python-pixie-hollow/tree/main/code-stash/logzero)
- [`pip-audit` library for scanning known vulnerabilities](https://github.com/blessymoses/python-pixie-hollow/tree/main/pip-audit)
